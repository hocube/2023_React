...
// 2. slice를 만들자 (slice란 하나의 store가 아니라 기능단위의 작은 store를 한다.)
//    나중에 작은 store(slice)를 합쳐서 Redux가 요구하는 큰 store로 Tollkit이 알아서 만들어준다.
    ...
    return(
        <div>
            ...
            <input type='button' value='+' onClick={()=>{
                ...
                // 인자 2는 plusSlice에서는 무조건 action.payload라고 지정된다.
